...
namespace SpreadCheck
{
    ...
    public Reporter(Excel.Workbook xlWorkbook, Excel.Worksheet curSheet, int endPosition)  //Constructor
		{	xlWrkBk = xlWorkbook;
            ...
            try { xlErrorSheet.Name = "Errors"; }
            catch {
                try
                {  xlErrorSheet.Name = "ErrorsList";
                } catch { MessageBox.Show("Unable to create Error Sheet"); }
            }
    }
